...
<body>
    ...
    <div class="detail">
        ...
        <div class="foto">
            <p><strong>KTP:</strong><br> <img src="../uploads/employees/<?php echo str_replace(' ', '_', $employee['name']) . '/' . $employee['ktp_photo']; ?>" width="300">

            <hr>
            <p><strong>KK:</strong><br> <img src="../uploads/employees/<?php echo str_replace(' ', '_', $employee['name']) . '/' . $employee['kk_photo']; ?>" width="300">
            <hr>
            <p><strong>Ijazah:</strong><br> <img src="../uploads/employees/<?php echo str_replace(' ', '_', $employee['name']) . '/' . $employee['ijazah_photo']; ?>" width="300">
        </div>
    </div>
